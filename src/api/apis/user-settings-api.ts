  ...
  return {
    ...
    async userSettingsGet(
      ...
      const localVarOperationServerBasePath =
        operationServerMap['UserSettingsApi.userSettingsGet']?.[localVarOperationServerIndex]?.url
     ...
     * @throws {RequiredError}
     */
    async userSettingsPut(
      userSettingsData: UserSettingsData,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.userSettingsPut(
        userSettingsData,
        options,
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserSettingsApi.userSettingsPut']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const UserSettingsApiFactory = function (
  ...
  return {
    ...
    userSettingsPut(
      ...
      return localVarFp
        .userSettingsPut(userSettingsData, options)
