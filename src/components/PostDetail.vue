    ...
    <span v-if="!edit">
      ...
      <div class="post-detail-meta-bar">
        <div class="post-meta detail">
          <h2>
            created&nbsp;by
            <RouterLink class="post-author-link" :to="'/profile/' + encodeURIComponent(data.authorUsername)">
          ...
          <div class="post-tags">
            <RouterLink class="post-category-link" :to="'/category/' + encodeURIComponent(data.category.uuid)">
