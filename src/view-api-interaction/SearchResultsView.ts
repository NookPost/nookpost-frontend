...
export async function fetchPostsByTextSearch(querry: string | undefined): Promise<Post[]> {
  const posts: Post[] = []
  ...
  try {
    response = await postApi.apiV1PostsGet(undefined, undefined, querry, undefined, undefined)
  } catch (err) {
