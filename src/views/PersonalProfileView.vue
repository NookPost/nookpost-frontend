...
const profile: Profile = {
  ...
  profilePictureBase64: 'https://images.pexels.com/photos/226746/pexels-photo-226746.jpeg',
}
</script>

<template>
  <div>User {{ id }}</div>
  <UserProfile :profile="profile" :editable="true" @update:profile="console.log"></UserProfile>
</template>
