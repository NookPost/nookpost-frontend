<template>
  ...
  <ul>
    ...
    <li>
      <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
        &quot;Our&quot; in this Agreement) refers to NookPost.</p>
    </li>
    <li>
    ...
    <li>
      <p><strong>Website</strong> refers to NookPost, accessible from <a href="https://nookpost-dev.jkulzer.dev"
          rel="external nofollow noopener" target="_blank">https://nookpost-dev.jkulzer.dev</a></p>
    </li>
    <li>
  ...
  <ul>
    <li>By email: webmaster@jkulzer.dev</li>
  </ul>
</template>
